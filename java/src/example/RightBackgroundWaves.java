...
public class RightBackgroundWaves {

    MyVisual mv;

    float cx = 0;

    public RightBackgroundWaves(MyVisual mv)
    {
        this.mv = mv;

        // for location of waveform
        cx = this.mv.width * 0.85f; 
    }
    ...
    public void render()
    {
        ...
        for (int i = 0; i < waveformSize; i++)
        {
            ...
            // these coordinates place the waveform on the right hand side of the screen vertically
            float x1 = cx;
